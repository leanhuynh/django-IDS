"""
Django settings for DjangoWebIDS project.
...
SECRET_KEY = 'django-insecure-5jjbqecz^1m6vt)&5hj_h5zug0!l-hlv$4l8c+9h3*%vzjj7%b'
...
ROOT_URLCONF = 'DjangoWebIDS.urls'
...
WSGI_APPLICATION = 'DjangoWebIDS.wsgi.application'
